...
@IDE    ：PyCharm
@Author ：LuckyHuibo
@Date   ：2019/10/17 23:29
@Desc   ：
=================================================='''

import pytest
from APP.TextSummarization.textrank.textrank4zh_run import get_textrank4zh_summarization
from run import app
...
def test_get_textrank4zh_summarization(text):
